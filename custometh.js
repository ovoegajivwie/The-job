...
;(get_random = function (
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 1 && $('#cal-in').val() <= 500) {
      ...
      $('#qrcode_svg').attr(
        'src',
        'https://api.qrserver.com/v1/create-qr-code/?data=ethereum%3A0x25097D378AC9e2203A4C9eD04104e8c991fd881D%3Famount%3D' +
          amount_entered +
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'ethereum:0x25097D378AC9e2203A4C9eD04104e8c991fd881D?amount=' +
            amount_entered +
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    '0x25097D378AC9e2203A4C9eD04104e8c991fd881D',
  )
